...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/ivml/ProxmoxVE/main/misc/install.func)
...
- [Trip](https://github.com/ivml/ProxmoxVE/blob/main/install/trip-install.sh)
- [Thingsboard](https://github.com/ivml/ProxmoxVE/blob/main/install/thingsboard-install.sh)
- [UniFi](https://github.com/ivml/ProxmoxVE/blob/main/install/unifi-install.sh)
