...
# upstream   https://github.com/ivml/ProxmoxVE.git (fetch)
# upstream   https://github.com/ivml/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/ivml/ProxmoxVE"
echo ""
