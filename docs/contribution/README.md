...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/ivml/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ivml/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/ivml/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/ivml/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/ivml/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ivml/ProxmoxVE/discussions)
