#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/ivml/ProxmoxVE/main/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/ivml/ProxmoxVE/main/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ivml/ProxmoxVE/main/tools/addon/runtipi.sh)"
MIGRATION_EOF
